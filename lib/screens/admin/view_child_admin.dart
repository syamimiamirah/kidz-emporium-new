...
class ViewChildAdminPage extends StatefulWidget {
  final LoginResponseModel userData;
  final List<ChildModel> children;

  const ViewChildAdminPage({Key? key, required this.userData, required this.children}) : super(key: key);

  @override
  _ViewChildAdminPageState createState() => _ViewChildAdminPageState();
}

class _ViewChildAdminPageState extends State<ViewChildAdminPage> {
