...
class _AdminSendMessagePageState extends State<AdminSendMessagePage> {
  static final GlobalKey<FormState> globalFormKey = GlobalKey<FormState>();TextEditingController _recipientController = TextEditingController();
        ...
        children: [
          ...
          Center(
            child: Padding(padding: const EdgeInsets.only(top: 10),
              child: FormHelper.inputFieldWidget(context, "subject", 'Subject', (onValidateVal){
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      FormHelper.submitButton(
                        "Send",
                            () async {
                          bool sent = await APIService.sendNotification(widget.bookingId, subject, message);
                          if (sent != null) {
