...
import 'details_report_therapist.dart';

class ViewReportTherapistPage extends StatefulWidget {
  final LoginResponseModel userData;

  const ViewReportTherapistPage({Key? key, required this.userData}): super(key: key);
  @override
  _ViewReportListPageState createState() => _ViewReportListPageState();
}

class _ViewReportListPageState extends State<ViewReportTherapistPage> {
  ...
  Future<void> _loadBooking(String userId) async {
    try {
      ...
      List<BookingModel> therapistBookings = loadedBookings.where((booking) => booking.therapistId == userId).toList();
      setState(() {
