...
class TaskDetailsTherapistPage extends StatefulWidget {
  final LoginResponseModel userData;
  final TaskModel task;

  const TaskDetailsTherapistPage({
    Key? key,
  ...
  @override
  _TaskDetailsTherapistPageState createState() => _TaskDetailsTherapistPageState();
}

class _TaskDetailsTherapistPageState extends State<TaskDetailsTherapistPage> {
